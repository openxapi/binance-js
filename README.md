...
|:--------:|:-------------:|
| `spot` | Spot API |
| `derivatives.umfutures` | USD-M Futures API |
| `derivatives.cmfutures` | COIN-M Futures API |
| `derivatives.options` | Options API |
| `derivatives.pmargin` | Portfolio Margin API |
| `derivatives.pmarginpro` | Portfolio Margin Pro API |
| `derivatives.futuresdata` | Futures Data API |
| `margin` | Margin API |
| `subaccount` | Subaccount API |
| `convert` | Convert API |
| `wallet` | Wallet API |
| `copytrading` | Copy Trading API |
