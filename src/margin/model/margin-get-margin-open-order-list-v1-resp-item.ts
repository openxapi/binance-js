 ...
 * 
 * @export
 * @interface MarginGetMarginOpenOrderListV1RespItem
 */
export interface MarginGetMarginOpenOrderListV1RespItem {
    /**
     * 
     * @type {string}
     * @memberof MarginGetMarginOpenOrderListV1RespItem
     */
